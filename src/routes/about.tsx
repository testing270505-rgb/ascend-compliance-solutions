  ...
  head: () => ({
    meta: [
      { title: "About Vision Consultancy — Our story, mission, team" },
      {
        name: "description",
        content:
          "A New Delhi & Mumbai-based regulatory consultancy enabling international companies, SMEs and startups to launch in India.",
      },
      { property: "og:title", content: "About — Vision Consultancy" },
      {
        property: "og:description",
        content: "Our story, mission and the team behind Vision's regulatory practice.",
      },
    ],
  }),
  component: AboutPage,
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          ...
          <h1 className="mt-4 font-display text-5xl md:text-7xl font-medium leading-[0.98] max-w-5xl text-balance">
            A reliable gateway to India's{" "}
            <span className="italic text-saffron">regulatory landscape.</span>
          </h1>
          <p className="mt-8 max-w-2xl text-lg text-muted-foreground">
            Vision is a private limited company based in New Delhi and Mumbai, specialising in
            technical certification and regulatory compliance for the Indian market. We provide
            comprehensive, single-window solutions for businesses navigating India's complex
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 grid gap-16 md:grid-cols-2">
        <Reveal>
          ...
          <p className="mt-5 text-muted-foreground">
            Vision started as a small BIS-focused practice and grew alongside India's expanding
            compliance requirements — adding WPC, BEE, TEC, NABL, ISO and trademark capabilities as
            our clients needed them. A decade later we still operate by the same principle:
            understand the product, then run the regulatory route end-to-end.
          </p>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="font-mono text-xs uppercase tracking-widest text-muted-foreground">
          ...
          <p className="mt-5 text-muted-foreground">
            We enable international companies, SMEs and startups to launch and scale in India by
            facilitating mandatory registrations and certifications — from initial strategy design
            to full implementation, with uncompromising adherence to safety, quality and
